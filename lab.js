...
let lovesCode = true;
if(lovesCode === true) {
  console.log('I love to code, boiiii!');
} else {
  console.log('Coding has its challenges... Womp Womp')
}
...
if(amysAge > brittanisAge) {
  console.log('Amy is OLD')
} else if(amysAge === brittanisAge){
  console.log('They is samesies')
} else {
  console.log('Brittani is OLD!!')
}
...
if(amysBirthYear === brittanisBirthYear) {
  console.log('They were born the same year, woooooow 😍')
...
for(i = 0; i < 4; i++) {
  if(score >= 90) { 
    ...
    console.log("B-EST EFFORT");
    break;
  }
  else if(70 <= score && score <= 79) { 
    console.log("C-RAZY DUDE");
    break;
  }
  else if(60 <= score && score <= 69) { 
    console.log("D-ON'T SKIP SCHOOL");
    break;
  }
  else if(score <= 59) { 
    console.log("F-UTURE IS SAD");
    break;
  }
}
...
if(myFavoriteNumbers.length < 7) {
  console.log("There aint no mo numbers than 6 dude")
} else {
